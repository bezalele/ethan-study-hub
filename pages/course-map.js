...
import { AREAS, getArea } from '../content/course.js?v=12';
import { getDetail } from '../content/courseDetails.js?v=12';
import { renderTriangle, wireTriangle } from '../components/power-triangle.js?v=12';
