...
function renderCourseMap(selected=1){
 const el=document.getElementById('courseMapContent'); if(!el)return;
 const u=courseAreas[selected-1];
 const hooks=[
  {why:'This is the origin story of the American system.',know:'You learn why the Constitution was created, what problem it was trying to solve, and why power was divided and limited.',life:'Every later unit makes more sense once you understand this foundation.'},
  {why:'This is the machinery of the U.S. government.',know:'You learn who makes the rules, who carries them out, who interprets them, and how each branch can stop the others from becoming too powerful.',life:'When you hear “Congress,” “the White House,” or “the Supreme Court” in the news, this unit tells you who can actually do what.'},
  {why:'This is where government power meets your freedom.',know:'You learn what the Constitution protects, how the Bill of Rights works, and how courts have applied equality and liberty.',life:'Speech, religion, privacy, due process, and equal protection are not abstract ideas — they affect real people.'},
  {why:'Politics begins before anyone enters a voting booth.',know:'You learn how family, community, ideology, events, and information shape political beliefs — and how polls try to measure them.',life:'It helps you separate what people believe from how we know what the public actually thinks.'},
  {why:'This is how citizens turn beliefs into political action.',know:'You learn how voting, parties, interest groups, campaigns, money, and media connect people to government.',life:'It explains how ordinary people try to influence who governs and what government does.'}
 ][selected-1];
 const visual=selected===2
 ? '<div class="gov-structure"><div class="gov-top"><b>WE THE PEOPLE</b><span>Constitutional authority begins with the people</span></div><div class="gov-trunk">U.S. CONSTITUTION</div><div class="gov-branches"><article><strong>ARTICLE I</strong><h4>Congress</h4><p>Makes laws</p><small>House + Senate</small></article><i>⇄</i><article><strong>ARTICLE II</strong><h4>President</h4><p>Executes laws</p><small>Departments + agencies</small></article><i>⇄</i><article><strong>ARTICLE III</strong><h4>Federal Courts</h4><p>Interprets laws</p><small>Supreme Court + lower courts</small></article></div><div class="gov-checks">↔ CHECKS & BALANCES ↔<small>No branch governs alone.</small></div></div>'
 : selected===1
 ? '<div class="summary-chain"><span>Declaration</span><i>→</i><span>Articles</span><i>→</i><span>Constitution</span><i>→</i><span>Bill of Rights</span></div>'
 : selected===3
 ? '<div class="summary-compare"><article><b>CIVIL LIBERTIES</b><span>Freedom from government interference</span></article><article><b>CIVIL RIGHTS</b><span>Equal treatment and protection under law</span></article></div>'
 : selected===4
 ? '<div class="summary-chain"><span>Experiences</span><i>→</i><span>Beliefs</span><i>→</i><span>Public opinion</span><i>→</i><span>Polling</span></div>'
 : '<div class="summary-chain"><span>Citizens</span><i>→</i><span>Parties & groups</span><i>→</i><span>Campaigns & media</span><i>→</i><span>Government</span></div>';
 el.innerHTML='<div class="cm-explorer"><aside class="cm-list"><p class="eyebrow">THE COURSE · FIVE AREAS</p>'+courseAreas.map(x=>'<button class="'+(x.n===selected?'active':'')+'" onclick="renderCourseMap('+x.n+')"><span>0'+x.n+'</span><div><small>UNIT '+x.n+' · '+x.weight+'</small><b>'+x.short+'</b><p>'+x.title+'</p></div><i>›</i></button>').join('')+'</aside><section class="cm-summary clean"><header><small>UNIT 0'+u.n+' · BEFORE YOU STUDY</small><h2>'+u.title+'</h2><p>'+hooks.why+'</p></header><div class="cm-summary-body"><section class="cm-knowledge"><div><p class="eyebrow">WHAT THIS CHAPTER IS REALLY ABOUT</p><h3>'+hooks.know+'</h3></div><aside><p class="eyebrow">WHY IT MATTERS</p><p>'+hooks.life+'</p></aside></section><section class="cm-visual"><p class="eyebrow">SEE THE IDEA</p>'+visual+'</section><div class="cm-topic-preview"><p class="eyebrow">WHAT YOU’LL LEARN NEXT</p>'+u.topics.map((t,i)=>'<button onclick="openUnitStudy('+u.n+')"><span>0'+(i+1)+'</span><b>'+t+'</b><i>→</i></button>').join('')+'</div><div class="cm-ready"><p class="eyebrow">READY TO GO DEEPER?</p><p>The study guide breaks this area into short explanations, visuals, examples, quizzes, and practice.</p><button class="cm-enter" onclick="openUnitStudy('+u.n+')">Open the full '+u.short+' study guide →</button></div></div></section></div>';
}
