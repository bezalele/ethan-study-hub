...
function journal(){crumbs([['Journal']]);return `<section class="hero hero--journal"><div class="hero-copy"><p class="eyebrow">AFTER SCHOOL</p><h1>What you learned, Ethan</h1><p>Write one short note a day. Pick any day on the calendar. Your mum and dad can react or comment, and you can reply.</p></div></section><div data-learning-history></div>`;}
