...
B('energy','food-energy','Food webs and energy pyramids','Read arrows and estimate transfers between trophic levels.','trophic',[
 ...
 ['Energy flows through systems','Organisms use much of the energy they obtain in metabolism, and energy is dispersed as heat. Only the energy stored in an organism’s biomass is available to the next trophic level when it is eaten. The often-used 10% transfer is a rough teaching approximation, not a universal constant.'],
 ['Matter and energy behave differently','Atoms can cycle between organisms and the environment. Energy flows through the system and becomes less available for biological work as it disperses. Decomposers recycle matter; they do not recycle energy — the energy they obtain is used and disperses as heat.']
 ...
 ['Use the 10% approximation',['Suppose producers store 10,000 energy units in biomass.','At a stated 10% transfer, primary consumers receive 1,000 units.','The next level receives about 100 units under the same assumption.','This uses the 10% approximation for practice, not a measured value.']],
...
],['Why are food chains usually unable to support many levels of large predators?',['Organisms use energy at every trophic level, and much of it disperses as heat.','Only a fraction of what one level obtains becomes new biomass for the next.','Successive transfers therefore leave progressively less energy available.','Energy supply, not appetite, is what limits how long a food chain can be.']],[
...
B('energy','carbon-cycle','Carbon and matter cycling','Follow carbon through organisms, air, water, and long-term stores.','carboncycle',[
 ...
 ['Trace a carbon atom through a meal',['Photosynthesis moves carbon from atmospheric CO₂ into plant sugars.','A person eats the plant, or an organism that ate the plant.','Cellular respiration can return that carbon to the air as CO₂.','This is one possible path; carbon can take many different routes.']],
 ['Explain a reservoir increase',['A reservoir gains 12 units of carbon and loses 8 during an interval.','12 − 8 = +4 units, so the reservoir increased.','The reservoir increased even though carbon was conserved, because the carbon came from another reservoir.']]
],['How can atmospheric CO₂ increase even though carbon is conserved?',['Carbon moves between reservoirs; it is not created or destroyed on the way.','Combustion can move carbon from long-term storage into the atmosphere.','If atmospheric inputs exceed atmospheric outputs, atmospheric storage increases.','Conservation applies to the whole system. It does not require every reservoir to stay constant.']],[
